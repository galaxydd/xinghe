...
Class: Generate
"""
def evaluate_legal_open_qa(data_file):
    """
...
if __name__ == "__main__":
    ...
    evaluate_legal_open_qa("../../prediction_result/zero-shot/glm-4-9b-chat/legal_open_qa.json")
    evaluate_legal_open_qa("../../prediction_result/zero-shot/baichuan-7b/legal_open_qa.json")
    evaluate_legal_open_qa("../../prediction_result/zero-shot/deepseek-v3/legal_open_qa.json")