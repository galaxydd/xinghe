...
from model_ge.disc_law_gen import Disc_generator
...
def main(model_name, data_file,is_few_shot,is_vllm):
    ...
    llm_generator.save_law_results(output_dir, model_name, data_file='un_success_counts.json',
                                   result_dict=un_success_dict)

if __name__ == "__main__":
    model_name = "disc-law"  # 传入模型名称
